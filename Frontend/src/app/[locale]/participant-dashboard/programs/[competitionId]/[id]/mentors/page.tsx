    ...
    <>
      <div className="flex items-center justify-between flex-wrap gap-x-2 gap-y-3">
        <div className="tabs-link flex flex-wrap gap-x-2 gap-y-3">
          <Link
            href={`/participant-dashboard/my-competitions/${competitionId}/${id}/mentors`}
          >
            <Button type="primary">{t("mentors")}</Button>
          </Link>
          <Link
            href={`/participant-dashboard/my-competitions/${competitionId}/${id}/mentors-sessions`}
          >
          ...
          {mentors.map((mentor) => (
            ...
            >
              ...
              <div className="mt-auto">
                <Link
                  href={`/participant-dashboard/my-competitions/${competitionId}/${id}/mentors/${mentor.id}`}
                >
