...
export default function TimelinePage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "path-to-mvp", "timeline"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "path-to-mvp", "timeline")});
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "path-to-mvp", "timeline"),
    onSuccess: () => {
      setIsCompleted(true);
