...
export default function FeaturesPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "path-to-mvp", "features"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "path-to-mvp", "features")});
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "path-to-mvp", "features"),
    onSuccess: () => {
      setIsCompleted(true);
