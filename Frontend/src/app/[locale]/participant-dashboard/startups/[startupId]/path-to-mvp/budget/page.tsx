...
export default function BudgetPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "path-to-mvp", "budget"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "path-to-mvp", "budget"),
    onSuccess: (data) => {
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "path-to-mvp", "budget"),
    onSuccess: () => {
      setIsCompleted(true);
