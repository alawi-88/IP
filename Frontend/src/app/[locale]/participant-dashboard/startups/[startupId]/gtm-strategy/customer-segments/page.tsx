...
export default function Customer-segmentsPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "gtm-strategy", "customer-segments"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "gtm-strategy", "customer-segments"),
    onSuccess: (data) => {
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "gtm-strategy", "customer-segments"),
    onSuccess: () => {
      setIsCompleted(true);
  ...
  return (
    <VaPageLayout
      title={t("va.customer-segments", "customer-segments")}
      breadcrumbs={[
