...
export default function OverviewPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "gtm-strategy", "overview"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "gtm-strategy", "overview"),
    onSuccess: (data) => {
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "gtm-strategy", "overview"),
    onSuccess: () => {
      setIsCompleted(true);
