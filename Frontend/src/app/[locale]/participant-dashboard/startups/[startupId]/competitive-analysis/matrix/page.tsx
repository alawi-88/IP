...
export default function MatrixPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "competitive-analysis", "matrix"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "competitive-analysis", "matrix")});
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "competitive-analysis", "matrix"),
    onSuccess: () => {
      setIsCompleted(true);
