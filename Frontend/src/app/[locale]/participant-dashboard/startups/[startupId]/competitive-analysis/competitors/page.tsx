...
export default function CompetitorsPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "competitive-analysis", "competitors"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "competitive-analysis", "competitors")});
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "competitive-analysis", "competitors"),
    onSuccess: () => {
      setIsCompleted(true);
  ...
  return (
    <VaPageLayout
      title={t("va.competitors", "competitors")}
      breadcrumbs={[
        { title: t("va.competitiveAnalysis", "Competitive Analysis") },
        { title: t("va.competitors", "competitors") },
      ]}
