...
export default function Gtm-overviewPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "strategic-frameworks", "gtm-overview"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "strategic-frameworks", "gtm-overview")});
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "strategic-frameworks", "gtm-overview"),
    onSuccess: () => {
      setIsCompleted(true);
  ...
  return (
    <VaPageLayout
      title={t("va.gtm-overview", "gtm-overview")}
      breadcrumbs={[
