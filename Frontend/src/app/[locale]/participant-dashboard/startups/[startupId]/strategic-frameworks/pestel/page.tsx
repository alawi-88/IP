...
export default function PestelPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "strategic-frameworks", "pestel"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "strategic-frameworks", "pestel")});
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "strategic-frameworks", "pestel"),
    onSuccess: () => {
      setIsCompleted(true);
