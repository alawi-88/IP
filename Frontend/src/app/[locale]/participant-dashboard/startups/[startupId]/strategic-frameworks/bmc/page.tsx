...
export default function BmcPage() {
  ...
  const { data: page, isLoading } = useQuery({
    queryKey: ["startup", startupId, "strategic-frameworks", "bmc"],
    queryFn: () =>
      startupApi.getVaPage(startupId, "strategic-frameworks", "bmc"),
    onSuccess: (data) => {
  ...
  const completeMutation = useMutation({
    mutationFn: () =>
      startupApi.completeVaPage(startupId, "strategic-frameworks", "bmc"),
    onSuccess: () => {
      setIsCompleted(true);
