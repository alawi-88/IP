...
import { ProgramApplicationList, Stage, ProgramApplication} from "@/lib/interfaces";
...
export default function JourneyPage() {
  ...
  const { data: myApplication, isLoading } = useQuery<ProgramApplication>({
  ...
  const stages = myApplication?.program?.stages || [];
