...
export default function LoginPage() {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      ...
      sessionStorage.setItem("judge_otp_email", email);
      sessionStorage.setItem("judge_otp_password", password);
      sessionStorage.setItem("judge_rememberMe", String(rememberMe ? 1 : 0));
      router.push("/judge/login/otp");
    },
  });
