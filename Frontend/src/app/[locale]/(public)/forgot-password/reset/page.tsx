...
export default function ResetPasswordPage() {
  ...
  const code = sessionStorage.getItem("participant_otp_rest_password") || "";
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: async (data: {
      ...
      const response = await axiosInstance.post(
        `/participants/reset-password?code=${code}`,
        {
          ...data,
        }
      );
    ...
    onSuccess: () => {
      ...
      sessionStorage.removeItem("participant_otp_rest_password");
    },
      ...
      <div className="card">
        <div className="text-center mb-8">
          ...
          <p className="text-primary text-xl">
            {t("set-strong-password-to-protect-your-account")}
          </p>
        </div>
