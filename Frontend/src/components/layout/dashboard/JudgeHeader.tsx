...
import DashboardNavbar from "./JudgeNavbar";
  ...
  return (
    <header className="flex justify-between w-full items-center p-3 lg:p-6 bg-card">
      <div className="flex flex-col font-medium">
        <p className="text-lg text-[#5B656A]">{t("welcome")}👋</p>
        <p className="text-sm text-[#667085] text-wrap">
      ...
      <div className="flex items-center gap-x-2 max-lg:ms-auto max-lg:me-4">
        ...
        <Button
          ...
          onClick={() => router.push("/judge/judge-dashboard/notifications")}
        >
          <Badge
            offset={[-30, -5]}
        ...
        <Link
          href={"/judge/judge-dashboard/profile"}
      ...
      <Drawer title={t("innovation-platform")} onClose={onClose} open={open}>
        <DashboardNavbar closeDrawer={onClose} />
      </Drawer>
    </header>
  );
}
