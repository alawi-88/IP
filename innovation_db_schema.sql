...
) ENGINE=InnoDB AUTO_INCREMENT=21857 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `assessment_criteria` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Description of what is being scored',
...
CREATE TABLE `branding_settings` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `email_bg_color` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_text_color` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_link_color` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_border_color` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `email_footer_footer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `competition_applications` (
  ...
  `idea_description` text COLLATE utf8mb4_unicode_ci,
  `idea_path_id` bigint unsigned DEFAULT NULL,
  `idea_challenge_id` bigint unsigned DEFAULT NULL,
  `participation_interest` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `type` enum('submission','draft') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'submission',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `form_id` bigint unsigned NOT NULL,
  `form_submissions` json DEFAULT NULL,
  `has_team` tinyint(1) NOT NULL DEFAULT '0',
  `registered_as` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `team_serial` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `events` (
  ...
  `title` json NOT NULL,
  `brief` json NOT NULL,
  `badge` enum('upcoming','completed') COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `time` time NOT NULL,
  `location` enum('virtual','onsite') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `form_ai_scoring_configs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `form_id` bigint unsigned NOT NULL,
  `ai_prompt` text COLLATE utf8mb4_unicode_ci COMMENT 'AI prompt defining role and assessment context',
...
CREATE TABLE `form_assessment_criteria` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `form_id` bigint unsigned NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Criteria name',
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Criteria description',
  `instruction` text COLLATE utf8mb4_unicode_ci COMMENT 'What the agent should do for this criterion',
...
CREATE TABLE `judge_projects` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `final_comment` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `judges` (
  ...
  `registration_method` enum('self-registration','admin-added') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'admin-added',
...
CREATE TABLE `landing_pages` (
  ...
  `dga_registration_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dga_certificate_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `mentor_sessions` (
  ...
  `video_tool` enum('zoom','teams','google_meet') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `feedback_strengths` text COLLATE utf8mb4_unicode_ci,
  `feedback_improvements` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `mentor_video_tools` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `mentor_id` bigint unsigned NOT NULL,
  `tool_type` enum('zoom','teams','google_meet') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `nafath_nationality_codes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nafath NationalityCode',
  `name_en` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'English name',
  `name_ar` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Arabic name',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `nafath_settings` (
  ...
  `login_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'both' COMMENT 'nafath, credentials, or both',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `notification_management` (
  ...
  `user_type` enum('participant','judge','all') COLLATE utf8mb4_unicode_ci NOT NULL,
  `competition_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `participants` (
  ...
  `recovery_email_temp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `activation_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `educational_background` enum('high_school','diploma','bachelor','master','phd') COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_role` enum('high_school_student','university_student','recently_graduated','private_sector_employee','government_sector_employee','non_profit_sector_employee','freelancer','unemployed') COLLATE utf8mb4_unicode_ci NOT NULL,
  `place_of_work_study` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `years_of_experience` enum('less_than_one','one_to_three','three_to_five','five_to_ten','more_than_ten','no_experience') COLLATE utf8mb4_unicode_ci NOT NULL,
  `experience_or_skills` text COLLATE utf8mb4_unicode_ci,
  `key_achievements` text COLLATE utf8mb4_unicode_ci,
  `password_reset_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_login_at` timestamp NULL DEFAULT NULL,
  `otp_login_code_expires_at` timestamp NULL DEFAULT NULL,
  `login_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'credentials',
...
CREATE TABLE `personal_access_tokens` (
  ...
  `created_from_ip` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_used_from_ip` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_used_user_agent` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `program_approval_requests` (
  ...
  `action_type` enum('create','update','delete','archive') COLLATE utf8mb4_unicode_ci NOT NULL,
  `requested_by` bigint unsigned NOT NULL,
  `approval_workflow_id` bigint unsigned NOT NULL,
...
CREATE TABLE `project_evaluation_notes` (
  ...
  `type` enum('general_feedback','issue_detected','administrative_decision','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general_feedback',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `registration_form_configs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `competition_id` bigint unsigned NOT NULL,
  `registration_type` enum('individual','team','both') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual',
