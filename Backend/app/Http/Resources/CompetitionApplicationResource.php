...
class CompetitionApplicationResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'competition' => new CompetitionResource($this->competition, null, $this->id),
            'form_id'        => $this->form_id,
            'submit_type' => !empty($this->type) ? $this->type : 'submission',
            'form'           => new CompetitionRegistrationFormResource(
                $this->form,
