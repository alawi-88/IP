...
class ApprovedProgramTab
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $isProgramTabVisible = $this->getProgramTabVisibility($programId, $tabEndpointMap[$routeName]);

        if (!$isProgramTabVisible) {
    ...
    private function getProgramTabVisibility($programId, $tabEndpoint): bool
    {
        return ProgramTab::where('program_id', $programId)
