...
class ProcessCompetitionApplicationAiEvaluation implements ShouldQueue
{
    ...
    {
        $application = CompetitionApplication::find($this->applicationId);
     ...
     */
    protected function markAsSkipped(CompetitionApplication $application, string $message): void
    {
        Log::warning('AI evaluation skipped for competition application', [
     ...
     */
    protected function markAsPending(CompetitionApplication $application, string $message): void
    {
        Log::error('AI evaluation failed for competition application', [
            'application_id' => $application->id,
            'form_id' => $application->form_id,
            'message' => $message,
        ]);
