...
use App\Traits\ProgramApplication\ManageStatus;
...
{
    use ManageStatus, FilterByProgram, LogsActivity, HasActivityLog;

    protected $with = ['program', 'participant'];
    ...
    protected string $moduleName = 'Program Application';
    protected string $logName = 'program_application';
    ...
    {
        // Check if there's already an active application for the same participant and program
        $existingActiveApplication = ProgramApplication::where('participant_id', $this->participant_id)
    ...
    {
        return RegistrationFormConfig::where('program_id', $this->program_id)
            ->active()
            ->first();
    }

    /**
     * Check if scoring is enabled for this application's program.
     */
    ...
    protected static function boot(): void
    {
        ...
        static::creating(function (ProgramApplication $application) {
    ...
    {
        return $this->hasMany(RegistrationEvaluation::class, 'program_application_id');
    }
        ...
        return [
            Tables\Columns\TextColumn::make('rank')
                ...
                ->getStateUsing(function ($record) {
                    ...
                    // Calculate rank among all non-archived submissions in the same program that have scores
            ...
            Tables\Columns\TextColumn::make('participant.name')
                ...
                ->sortable(query: function ($query, $direction) {
                    return $query->join('participants', 'program_applications.participant_id', '=', 'participants.id')
