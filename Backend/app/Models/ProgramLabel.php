...
class ProgramLabel extends Model
{
    ...
    /**
     * Default labels that get seeded when a program is created.
     */
    public const DEFAULT_LABELS = [
        ...
        ['key' => 'nav_my_programs', 'category' => 'navigation', 'label_en' => 'My Programs', 'label_ar' => 'مسابقاتي'],
     ...
     */
    public static function seedDefaults(int $programId): void
    {
