...
class CompetitionStatsCount extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $applicationsQuery = CompetitionApplication::byCompetition()->submission()->active();
        ...
        $eventsCount = $this->applyDateFilter(Event::byCompetition(), $from, $to)->count();
        $mentorsCount = $this->applyDateFilter(Mentor::byCompetition(), $from, $to)->count();
        $teamCount = $this->applyDateFilter(Team::byCompetition(), $from, $to)->count();
        $guidelines = $this->applyDateFilter(Guideline::byCompetition(), $from, $to)->count();

        $projectsQuery = Project::byCompetition()->submission();
        ...
        $satisfactionsQuery = Satisfaction::byCompetition();
        ...
        $teamsIds = Team::byCompetition()->whereIn('application_id', $applications->pluck('id')->toArray())->pluck('id');
        ...
        $formIds = Form::byCompetition()->pluck('id');
        ...
        foreach ($fields as $field) {
            ...
            $submissions = CompetitionApplication::where('form_id', $field->form_id)->get();
