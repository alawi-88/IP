...
class ViewCompetitionApplication extends ViewRecord
{
    ...
    protected function resolveRecord(string|int $key): \Illuminate\Database\Eloquent\Model
    {
        ...
        if (!CompetitionApplicationResource::canView($record)) {
            abort(404);
        }
    ...
    protected function getHeaderActions(): array
    {
        ...
        return [
            ...
            Action::make('restore')
                ...
                ->authorize(fn () => CompetitionApplicationResource::canRestore($this->record))
                ->visible(fn () => $this->record->isArchived())
                ->action(function () {
                    $this->record->restore();
                    Notification::make()
                    ...
                    $this->redirect(CompetitionApplicationResource::getUrl('index'));
                }),
        ];
    }
