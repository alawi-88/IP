...
class ListContactUs extends ListRecords
{
    ...
    {
        $baseQuery = ContactUs::query()->where('model_type', Judge::class);
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('archive')
                    ...
                    ->visible(fn (ContactUs $record) => JudgeContactUsResource::canArchive($record)),
                ...
                Tables\Actions\Action::make('restore')
                    ...
                    ->visible(fn (ContactUs $record) => JudgeContactUsResource::canRestore($record)),
                            ...
                            try {
                                ...
                                foreach ($records as $record) {
                                    if ($record->isArchived()) {
                                        ...
                                        if (JudgeContactUsResource::canArchive($record)) {
                                            $record->archive();
                                            $count++;
                                        }
                                    }
                            ...
                            try {
                                ...
                                foreach ($records as $record) {
                                    if (!$record->isArchived()) {
                                        ...
                                        if (JudgeContactUsResource::canRestore($record)) {
                                            $record->restore();
                                            $count++;
                                        }
                                    }
