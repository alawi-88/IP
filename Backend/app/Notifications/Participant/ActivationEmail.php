    ...
    public function toMail($notifiable): MailMessage
{
            ...
            //$template = EmailTemplate::where('key', 'user.registration_confirmation')->first();
            $greeting = ' ';
            $data = $this->renderEmailTemplate('user.registration_confirmation', [    'name' => $notifiable->name, 'url' => $url,]);
    ...
    protected function verificationUrl($notifiable)
    {
        ...
        return config('app.url') . '/ar/register/verify?' . http_build_query([
