...
return new class extends Migration
{
    ...
    public function up(): void
    {
            ...
            if (!Schema::hasColumn('project_evaluations', 'is_archived')) { $table->boolean('is_archived')->default(false); }
            if (!Schema::hasColumn('project_evaluations', 'archived_at')) { $table->timestamp('archived_at')->nullable(); }
        });
        }
    }
