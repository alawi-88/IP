...
return new class extends Migration
{
    ...
    public function up(): void
    {
            ...
            if (!Schema::hasColumn('registration_form_configs', 'is_archived')) { $table->boolean('is_archived')->default(false); }
            if (!Schema::hasColumn('registration_form_configs', 'archived_at')) { $table->timestamp('archived_at')->nullable(); }
        });
        }
    }
