...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (in_array('mentors_competition_id_foreign', $__fkNames)) {
            Schema::table('mentors', fn(Blueprint $t) => $t->dropForeign(['competition_id']));
        }

            Schema::table('mentors', function (Blueprint $table) {
            if (!Schema::hasColumn('mentors', 'competition_id')) { $table->foreignId('competition_id')->constrained()->onDelete('cascade'); }
        });
        }
    }
